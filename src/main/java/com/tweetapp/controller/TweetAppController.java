...
public class TweetAppController {
    ...
    public ResponseEntity<Tweet> updateTweet(@PathVariable String userName,@PathVariable int id ,@Valid @RequestBody Tweet tweets){
    ...
    public ResponseEntity<List<String>> searchByUserName(@RequestBody UserProfile user){
    ...
    public ResponseEntity<String> deleteingTweet(@PathVariable String userName,@PathVariable int id){
    ...
    public ResponseEntity<Tweet> addlike(@PathVariable String userName,@PathVariable int id){
    ...
    public ResponseEntity<Tweet> replyingTweet(@PathVariable String userName, @PathVariable int id, @RequestBody JsonNode reply){
